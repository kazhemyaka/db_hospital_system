<?php
    ...
    $query = "SELECT * FROM Patient WHERE Email = '{$_SESSION['email']}'";
    ...
    if (isset($_POST['submit_phone'])) {
        ...
        $phone_update_query = "UPDATE Patient SET Phone = '$phone_number' WHERE Email = '{$_SESSION['email']}'";
    ...
    if (isset($_POST['submit_email'])) {
        ...
        $email_update_query = "UPDATE Patient SET Email = '$email' WHERE Email = '{$_SESSION['email']}'";
    ...
    if (isset($_POST['submit_password'])) {
        ...
        $password_update_query = "UPDATE Patient SET Password = SHA2('$password', 256) WHERE Email = '{$_SESSION['email']}'";
    ...
    <div class="d-flex flex-nowrap">
        <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark min-vh-100">
            ...
            <ul class="nav nav-pills mb-sm-auto mb-0 flex-column">
                ...
                <li class="nav-item">
                    <a href="patient_dashboard_medicines.php" class="nav-link text-white d-flex align-items-center align-content-center">
            ...
            <div class="px-4 py-5 my-5 text-center">
                ...
                <div class="container text-center">
                        ...
                        <div class="col-lg-4 col-md-12 mt-1">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><?php echo $row['Birthday'] ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 mt-1">
                    ...
                    <div id="phone_number_form" class="mt-5" style="display: none">
                        <form method="POST" action="patient_dashboard_profile.php">
