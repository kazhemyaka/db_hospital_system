<?php
    ...
    $query = "SELECT Diagnosis_ID, Doctor.Doc_Photo_Url, CONCAT(Doctor.Doc_First_Name, ' ', Doctor.Doc_Last_Name) AS Doctor_Name, Diagnosis_Name, Diagnosis_Notes, Diagnosis_Date, Diagnosis_File FROM Diagnosis JOIN Doctor ON Diagnosis.Doctor_ID = Doctor.Doctor_ID WHERE Diagnosis.Patient_ID =" . $_SESSION['patient_id'];
...
<meta charset="UTF-8">
    ...
    <title>My diagnoses - Dashboard</title>
