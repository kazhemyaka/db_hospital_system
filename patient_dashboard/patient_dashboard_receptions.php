<?php
    ...
    $query = "SELECT Reception_ID, Doctor.Doc_Photo_Url, CONCAT(Doctor.Doc_First_Name, ' ', Doctor.Doc_Last_Name) AS Doctor_Name, Rec_Date, Rec_Time FROM Reception JOIN Doctor ON Reception.Doctor_ID = Doctor.Doctor_ID WHERE Reception.Patient_ID =" . $_SESSION['patient_id'];
...
<meta charset="UTF-8">
    ...
    <title>My receptions - Dashboard</title>
