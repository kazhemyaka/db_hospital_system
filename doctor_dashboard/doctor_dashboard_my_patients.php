<?php
    ...
    $query = "SELECT Patient.Patient_ID, Photo_Url, CONCAT(First_Name, ' ', Last_Name) AS Patient_Name, Birthday, Gender, Address, Phone, Email FROM Patient JOIN (SELECT DISTINCT Patient_ID, Doctor_ID FROM Reception) Reception ON Patient.Patient_ID = Reception.Patient_ID JOIN Doctor ON Reception.Doctor_ID = Doctor.Doctor_ID WHERE Doctor.Doctor_ID = " . $_SESSION['doctor_id'];
...
<head>
    ...
    <title>My patients - Dashboard</title>
        ...
        <div class="container">
            <div class="px-4 py-5 my-5">
                ...
                <div class="alert alert-danger d-flex align-items-center mt-5" role="alert">
                    ...
                    Warning: Deleting a patient will delete all existing receptions, diagnoses, and medicines for the patient.
                </div>
                <table class="table mt-4" id="table-patients">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary me-2" href="edit_patient.php?id=<?php echo $row['Patient_ID']; ?>" role="button"><i class="bi bi-pencil-square"></i></a>
                                    <a class="btn btn-primary" id="delete-btn" href="delete_patient.php?id=<?php echo $row['Patient_ID']; ?>" role="button"><i class="bi bi-trash3"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
