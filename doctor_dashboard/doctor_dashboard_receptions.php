<?php
    ...
    $query = "SELECT Reception_ID, Patient.Photo_Url, CONCAT(Patient.First_Name, ' ', Patient.Last_Name) AS Patient_Name, Rec_Date, Rec_Time FROM Reception JOIN Patient ON Reception.Patient_ID = Patient.Patient_ID WHERE Doctor_ID = " . $_SESSION['doctor_id'];
    ...
    <div class="d-flex flex-nowrap">
        ...
        <div class="container">
            <div class="px-4 py-5 my-5">
                <h1>
                    Receptions
                    <a class="btn btn-primary ms-2" href="new_reception.php"><i class="bi bi-calendar-plus me-2"></i>New reception</a>
                </h1>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary me-2" href="edit_reception.php?id=<?php echo $row['Reception_ID']; ?>" role="button"><i class="bi bi-pencil-square"></i></a>
                                    <a class="btn btn-primary" id="delete-btn" href="delete_reception.php?id=<?php echo $row['Reception_ID']; ?>" role="button"><i class="bi bi-trash3"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
